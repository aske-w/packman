...
export const useSetSidewaysScrollbar = (scrollableWidth: number, layerRef: RefObject<KonvaLayer>, visibleWidth: number, startX: number, scrollbarRef: RefObject<KonvaRect>, deltaX?: number) => {
    useEffect(() => {
