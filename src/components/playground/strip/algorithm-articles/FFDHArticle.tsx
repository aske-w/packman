...
const FFDHArticle: React.FC<FFDHArticleProps> = ({}) => {
  ...
  return (
    <>
      <p>First fit decreasing height builds on the principles of Next fit decreasing height.</p>
      <h4>Preparation</h4>
      <p>
        Since this is an{' '}
      ...
      <div className="flex flex-col items-center p-5 bg-gray-700 rounded-lg not-prose">
        <svg width="792" height="158" viewBox="0 0 792 158" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <p>
        When placing the next rectangle, we now look at the bottom most shelf. We check that the remaining width of the shelf is enough to accomodate
        the rectangle. This leads to two cases:
      </p>
      <ol>
        <li>If there is enough space, the rectangle is placed in the same shelf</li>
        <li>
          Otherwise, we check the shelf above to see if it can accomodate the rectangle. If it can it will be placed. Otherwise we continue checking
          all shelves above, if none can accomodate it, we create a new shelf and it is placed there.
        </li>
      </ol>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center self-center p-5 mt-5 bg-gray-700 rounded-lg not-prose max-w-min">
          <svg width="554" height="319" viewBox="0 0 554 319" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="554" height="319" fill="white" />
            <rect x="413.5" y="300.5" width="104" height="18" fill="#FBBF24" stroke="black" />
            <rect x="231.5" y="220.5" width="77" height="98" fill="#FBBF24" stroke="black" />
            <rect x="309.5" y="230.5" width="25" height="88" fill="#FBBF24" stroke="black" />
            <rect x="335.5" y="270.5" width="77" height="48" fill="#FBBF24" stroke="black" />
            <rect x="0.5" y="129.5" width="149" height="31" fill="#FBBF24" stroke="black" />
